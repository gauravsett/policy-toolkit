...
- `tools/` — Installable artifacts (skills, CLAUDE.md starters, agent configs, hooks). Each tool is a self-contained folder with a README.
...
- If you modify this file (CLAUDE.md), make the equivalent update to AGENTS.md so they stay in sync.
